...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 27 12:25:49 2021
...
from second.data.preprocess import _read_and_prep_ikg
...
class ikgDataset(Dataset):
    def __init__(self, info_path, root_path, num_point_features,
        ...
        self._ikg_infos = infos
        self._num_point_features = num_point_features
        print("remain number of infos:", len(self._ikg_infos))
    ...
    def __len__(self):
        return len(self._ikg_infos)

    @property
    def kitti_infos(self):
        return self._ikg_infos

    def __getitem__(self, idx):
        return _read_and_prep_ikg(
            info=self._ikg_infos[idx],
